...
<body style="background: url('{{ asset('public/backend/images/bg_admin.png') }}') no-repeat 0px 0px; background-size: cover;">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-delivery')}}">Thêm giá vận chuyển</a></li>
                        <li><a href="{{URL::to('/all-delivery')}}">Liệt kê giá vận chuyển</a></li>
                    </ul>
                </li>
                <li>
