...
<script>
    ...
    $('.add-to-cart').click(function() {
        ...
        var cart_product_id = id; // Lấy id sản phẩm từ nút
        ...
        var cart_product_qty = $('.product_qty_' + id).val(); // Mặc định 1 nếu không có
...
<div class="product-details"><!--product-details-->
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p>Mã sản phẩm: {{$productDetail->product_id}}</p>
            ...
            <span>
                ...
                <input type="hidden" class="product_id_{{$productDetail->product_id}}" value="{{$productDetail->product_id}}">
                <input type="hidden" class="product_name_{{$productDetail->product_id}}" value="{{$productDetail->product_name}}">
                <input type="hidden" class="product_image_{{$productDetail->product_id}}" value="{{$productDetail->product_image}}">
                <input type="hidden" class="product_price_{{$productDetail->product_id}}" value="{{$productDetail->product_price}}">
                <input name="quantity" type="number" class="product_qty_{{$productDetail->product_id}}" value="1" min="1"/>
                <button type="button" 
